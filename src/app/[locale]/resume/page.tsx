  ...
  return (
    <main className="min-h-screen bg-bg py-10 print:bg-white print:py-0">
      ...
      <article className="mx-auto w-full max-w-[52rem] border border-line bg-white px-8 py-10 text-neutral-900 shadow-sm sm:px-12 print:max-w-none print:border-0 print:p-0 print:shadow-none">
        <header className="flex flex-col-reverse items-start gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6 print:flex-row print:justify-between">
          ...
          <img
            ...
            width={96}
            height={96}
            className="size-20 shrink-0 rounded-xl border border-neutral-300 object-cover sm:size-24"
          />
        </header>
